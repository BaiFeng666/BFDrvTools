...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, magiXOR(L"BFDrv").decrypt(), NULL};
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, magiXOR(L"BFDrv").decrypt(), WS_POPUP | CW_USEDEFAULT, 0, 0, gui->window_size.x, gui->window_size.y, NULL, NULL, wc.hInstance, NULL);
...
void SetupImGui(HWND hWnd) {
    ...
    const char* standardColors = "Dark mode";
    ...
    io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\msyh.ttc", 17.0f, 0, io.Fonts->GetGlyphRangesChineseFull());
